...
| Compatibility | `mode compatibility status/set` | Standard and restart-dependent Low resolution/360p modes are verified for firmware `v0.2.9.8_build3`. |
